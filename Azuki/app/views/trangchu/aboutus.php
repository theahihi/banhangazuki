...
<div class="box-banner-about">
    ...
    <div class="box-introduce">
        <div class="in-introduce">
            ...
            <div class="title-introduce">
                <div class="in-title-introduce">The furture of azuki</div>
            </div>
            <div class="on-title">
    ...
    <div class="box-banner-about-2">
        <div class="in-box-banner">
            <img src="<?php echo WEBROOT . 'public/client/Picture/Shop/banner-33.jpg'?>" alt="">
        </div>
    </div>
    <div class="box-introduce-1">
        <div class="box-picture">
            <img src="<?php echo WEBROOT . 'public/client/Picture/Shop/banner-34.jpg'?>" alt="">
        </div>
