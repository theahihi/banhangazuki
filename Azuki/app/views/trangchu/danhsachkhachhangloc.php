            ...
            while ($row = mysqli_fetch_array($dskh)) {
                ...
                <tr>
                    ...
                    <td><?php
                        ...
                        ?></td>
                    <td>
                        <button class="btn edit" onclick="openEditPopup('<?php echo $row['id']; ?>', '<?php echo $row['hoten']; ?>', '<?php echo $row['sodienthoai']; ?>')" style="background-color: #0056b3; color: white; border: none; padding: 8px 12px; border-radius: 4px; cursor: pointer;">
