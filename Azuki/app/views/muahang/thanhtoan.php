...
<div class="luachon">
  <?php  if(isset($_POST['quantities'])){  ?>
      <div class="chon_giohang">
        <a href="/azuki/muahang/giohang"><h2 style="font-size: 50px;">Giỏ hàng</h2></a>
      </div>
      <div class="muiten">
 ...
 <form action="/azuki/muahang/xulythanhtoan<?php 
...
<div class="khungchitietthanhtoan">
      ...
      <div class="motadonhang">
        <div class="title_motadonhang">
          ...
          <?php   if(isset($_POST['quantities'])){?>
          <h4>Mã đơn hàng: <span style="color: red"> azuki<?php echo $_POST['mahd'];?></span></h4>
          <?php  }?>
        </div>
        <div class="bang_mota_donhang">
          <table>
            ...
            <?php
            if(isset($_POST['quantities'])){
            $_SESSION['soluong'] = json_decode($_POST['quantities'], true);   
            }
            $tongtien = 0;
            ...
            <tr>
              <td style="display: flex;">
                <img src="<?php echo WEBROOT . 'public/client/Picture/anhsanpham/' . $row['anhhienthi1']; ?>" alt="" style="height: 50px; width: 50px;">
               <p style=" margin-left: 10px; "> <?php echo $row['tensp']?> </p>
              </td>
        ...
        <div class="phuongthucthanhtoan">
          ...
          <div class="hdchuyenkhoan">
            <div class="stk_nd">
              <p>Hướng dẫn thanh toán</p>
              <ul>
                <li>Tên ngân hàng: MB BANK</li>
                <li>Số tài khoản: 231020031234</li>
                <li>Tên chủ sở hữu: NGUYEN DUC THE</li>
                <li>Nội dung chuyển khoản: EQXUI89</li>
              </ul>
            </div>
            <div class="maqr">
              <p>Chuyển khoản bằng quét mã</p>
